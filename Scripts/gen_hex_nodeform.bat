@echo off
set DATA_ROOT_PATH=D:\paper\mypaper\polyhexpaper\CEPolyCube_input
set HEXEX_PATH=D:\Lib\HexEx_Windows
set HEX_OPT_PATH=..\Bin
set POLYCUT_PATH=D:\Lib\polycut_public_release_20180929
...
@REM ..\Bin\ScissorPoly.exe -input_name %WORKING_PATH%\%1_split.ovm -input_fea_name %WORKING_PATH%\%1.fea -output_name %WORKING_PATH%\%1_deform.vtk -mode 0 >> %1_log.txt

echo LABELING
..\Bin\tetvtk2mesh.exe %WORKING_PATH%\%1_split.vtk %WORKING_PATH%\%1_deform.mesh
...
echo FLATTENING
..\Bin\ScissorPoly.exe -input_name %WORKING_PATH%\%1_split.vtk -input_cl_name %WORKING_PATH%\%1_chartlabel.txt -output_name %WORKING_PATH%\%1_deform_polycube.vtk -mode 1 -sr 2 -smd 0 -ac 0 -hex_flag 1 >> %1_log.txt
