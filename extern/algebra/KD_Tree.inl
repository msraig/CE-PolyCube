namespace ig
{
	...
	//////////////////////////////////////////////////////////////
	template <typename T, int Dim>
	void KD_Tree<T, Dim>::find_Nearest_Point(const Vector& query, CVec<T, Dim>& nearestP, ptrdiff_t* primitive_id)
	{
	...
	//////////////////////////////////////////////////////////////
	template <typename T, int Dim>
	void KD_Tree<T, Dim>::find_Nearest_Point_by_traverse(const Vector& query, CVec<T, Dim>& nearestP, ptrdiff_t* primitive_id)
	{
		T rst;
